...
import com.example.realm.adapters.NoteAdapter;
...
public class NoteActivity extends AppCompatActivity implements RealmChangeListener<Board> {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.edit_note:
                showAlertForEditingNote("Edit Description", "Change the desc of the Note", notes.get(info.position));
                return true;
