package com.jmendoza.inventario.mainModule.view;
...
import com.jmendoza.inventario.addModule.view.AddProductFragment;
import com.jmendoza.inventario.common.pojo.Product;
import com.jmendoza.inventario.detailModule.view.DetailFragment;
import com.jmendoza.inventario.mainModule.MainPresenter;
import com.jmendoza.inventario.mainModule.MainPresenterClass;
import com.jmendoza.inventario.mainModule.view.adapters.OnItemClickListener;
import com.jmendoza.inventario.mainModule.view.adapters.ProductAdapter;
...
public class MainActivity extends AppCompatActivity implements OnItemClickListener, MainView {
    ...
    public void onAddClicked() {
        new AddProductFragment().show(getSupportFragmentManager(), getString(R.string.add_product_title));
    }
    ...
    public void onItemClick(Product product) {
        ...
        getSupportFragmentManager().beginTransaction()
                .add(R.id.contentMain, DetailFragment.instantiate(this, FRAGMENT_DETAIL_PRODUCT, arguments),
    ...
    public void onLongItemClick(final Product product) {
        ...
        .setPositiveButton(R.string.main_dialog_remove_ok, (dialogInterface, i) ->
                mPresenter.remove(product)).setNegativeButton(R.string.common_dialog_cancel, null)
        .show();
    }
